...
public class Jokes {
    ...
    private void initJokes() {
        mGoodJokes.add("Want to hear a word I just made up? \nPlagiarism!");
        ...
        mGoodJokes.add("Folks, I don’t trust children. They’re here to replace us.\n --Stephen Colbert");
        ...
        mBadJokes.add("What's stucco? \nIt's what happens when you step in bubblegummo.");
        mBadJokes.add("What is the Karate experts favorite beverage?\n Kara-tea.");
        mBadJokes.add("Where do Floridians wash their clothes? \nIn Fort Launderdale.");
        mBadJokes.add("Knock Knock. \nWho’s there?\n The Truth. No joke. \n--Stephen Colbert");
    }
